...
# Reports directory (same pattern as original server.py)
...
def report():
    # Body is the `report` object sent from app.js
    data = request.get_json(silent=True) or {}

    # Normalise fields similar to the original logger
    timestamp_iso = datetime.utcnow().isoformat()
    user_agent = request.headers.get('User-Agent', '')

    # Save full JSON into ./reports/<something>.json
    ...
    # Append a concise row into ./reports/log.csv
